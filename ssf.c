...
WireFrame missileWireFrame = (WireFrame) { .points[0] = (Point){0,0},
                                           ...
                                           .points[3] = (Point){ -5, -5 },
                                           .pointCount = 4,
                                           .lines[0] = (WireFrameLine){ 0, 1 },
                                           .lines[1] = (WireFrameLine){ 0, 2 },
                                           .lines[2] = (WireFrameLine){ 0, 3 },
                                           .lineCount = 3,
                                           .r = 255,
                                           .g = 255,
                                           .b = 255 };

WireFrame shellWireFrame = (WireFrame) { .points[0] = (Point){ -8, 0 },
                                         .points[1] = (Point){ 0, -6 },
                                         .points[2] = (Point){ 16, 0 },
                                         .points[3] = (Point){ 0, 6 },
                                         .points[4] = (Point){ -8, 0 },
                                         .pointCount = 5,
                                         .lines[0] = (WireFrameLine){ 0, 1 },
                                         .lines[1] = (WireFrameLine){ 1, 2 },
                                         .lines[2] = (WireFrameLine){ 2, 3 },
                                         .lines[3] = (WireFrameLine){ 3, 0 },
                                         .lineCount = 4,
                                         .r = 255,
                                         .g = 0,
                                         .b = 0 };

WireFrame shipWireFrame = (WireFrame) { .points[0] = (Point){ -18, 0 },
                                        .points[1] = (Point){ 18, 0 },
                                        .points[2] = (Point){ 0, 0 },
                                        .points[3] = (Point){ -18, 18 },
                                        .points[4] = (Point){ -18, -18 },
                                        .pointCount = 5,
                                        .lines[0] = (WireFrameLine){ 0, 1 },
                                        .lines[1] = (WireFrameLine){ 3, 2 },
                                        .lines[2] = (WireFrameLine){ 2, 4 },
                                        .lineCount = 3,
                                        .r = 255,
                                        .g = 255,
                                        .b = 0 };

WireFrame fortressWireFrame = (WireFrame) { .points[0] = (Point){ 0, 0 },
                                            .points[1] = (Point){ 36, 0 },
                                            .points[2] = (Point){ 18, -18 },
                                            .points[3] = (Point){ 0, -18 },
                                            .points[4] = (Point){ 18, 18 },
                                            .points[5] = (Point){ 0, 18 },
                                            .pointCount = 6,
...
void initGame(Game *game) {
  ...
  game->fortress.o.position.y = 315;
