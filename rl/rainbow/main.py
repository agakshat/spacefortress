...
parser.add_argument('--game', type=str, default='youturn', help='Space Fortress')
...
parser.add_argument('--save-dir', type=str, default='results_temp')
...
env.seed(args.seed)
env = WrapPyTorch(env,args.history_length)
